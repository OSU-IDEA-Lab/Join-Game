...
def constructQueries(vals):
    ...
    #for val in vals:
        #for sch_val in sch_vals:
            ...
            # Q12 - TPCH
    result.append("select o_orderkey, l_orderkey from order1 join lineitem1 on  levenshtein(trim(o_orderkey::varchar(10)), trim(o_orderkey::varchar(10))) <= 1 limit 100000;")
    return result

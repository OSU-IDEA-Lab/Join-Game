...
def constructQueries():
    ...
    result.append("SELECT Drugs_source.drugName, Drugs_target.page_title FROM Drugs_source JOIN Drugs_target ON levenshtein(trim(Drugs_source.drugName::varchar(10)), trim(Drugs_target.page_title::varchar(10))) <= 10 LIMIT 100000;")
    return result

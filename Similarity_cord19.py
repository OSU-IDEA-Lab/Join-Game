...
def constructQueries():
    ...
    result.append("SELECT cord_19_source.abstract, cord_19_target.paper_title FROM cord_19_source JOIN cord_19_target ON levenshtein(trim(cord_19_source.abstract::varchar(10)), trim(cord_19_target.paper_title::varchar(10))) <= 5 LIMIT 100000;")
    return result

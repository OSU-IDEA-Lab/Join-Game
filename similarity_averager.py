    ...
    for sets in datasets:
        ...
        for lv in lvs_to_use:
            for weight in weights:
                file_paths = [
                    f'/data/saketh_temp/PSQL1506/Join-Game/Join_Summary/{algorithm}/{weight}/sum_similarity_lv{lv}_{sets}1_{weight}.dat',
                    f'/data/saketh_temp/PSQL1506/Join-Game/Join_Summary/{algorithm}/{weight}/sum_similarity_lv{lv}_{sets}2_{weight}.dat',
                    f'/data/saketh_temp/PSQL1506/Join-Game/Join_Summary/{algorithm}/{weight}/sum_similarity_lv{lv}_{sets}3_{weight}.dat'
                ]

                output_file_path = f'/data/saketh_temp/PSQL1506/Join-Game/Results/{algorithm}/sum_similarity_lv{lv}_{sets}_avg_{weight}.dat'

...
def constructQueries():
    ...
    result.append("SELECT fullWDC1.name, fullWDC2.name FROM fullWDC1 JOIN fullWDC2 ON levenshtein(trim(fullWDC1.name::varchar(10)), trim(fullWDC2.name::varchar(10))) <= 6 LIMIT 100000;")
    return result

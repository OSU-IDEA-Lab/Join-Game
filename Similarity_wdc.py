...
def constructQueries():
    ...
    result.append("SELECT wdc_source.prod_title, wdc_target.prod_title FROM wdc_source JOIN wdc_target ON levenshtein(trim(wdc_source.prod_title::varchar(10)), trim(wdc_target.prod_title::varchar(10))) <= 10 LIMIT 100000;")
    return result

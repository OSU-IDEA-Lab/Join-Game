...
def constructQueries():
    ...
    result.append("SELECT DrugCentral_source.name, DrugCentral_target.name FROM DrugCentral_source JOIN DrugCentral_target ON levenshtein(trim(DrugCentral_source.name::varchar(10)), trim(DrugCentral_target.name::varchar(10))) <= 3 LIMIT 100000;")
    return result

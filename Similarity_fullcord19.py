...
def constructQueries():
    ...
    result.append("SELECT fullcord19_1.authors, fullcord19_2.authors FROM fullcord19_1 JOIN fullcord19_2 ON levenshtein(trim(fullcord19_1.authors::varchar(10)), trim(fullcord19_2.authors::varchar(10))) <= 6 LIMIT 100000;")
    return result
...
def measureTimeForKs(conn, joinQuery, ks, sigma, data_filename, iteration):
    ...
    try:
        ...
        cur.execute('set statement_timeout = 180000000;') #1800000 = 30 mins
        ...
        for row in cur:
            ...
            if joinTime >= 180000000: #900 = 15 min, 1500 = 25 min
                break

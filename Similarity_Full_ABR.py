...
def constructQueries():
    ...
    result.append("SELECT books_data.title, reviews.title FROM books_data JOIN reviews ON levenshtein(trim(books_data.title::varchar(10)), trim(reviews.title::varchar(10))) <= 6 LIMIT 100000;")
    return result
